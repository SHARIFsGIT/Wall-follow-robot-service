...
(cl:in-package your_package_name-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <FindWall-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindWall-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name your_package_name-srv:<FindWall-request> is deprecated: use your_package_name-srv:FindWall-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FindWall-request>)))
  ...
  "your_package_name/FindWallRequest")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindWall-request)))
  "Returns string type for a service object of type 'FindWall-request"
  "your_package_name/FindWallRequest")
...
(cl:defmethod cl:initialize-instance :after ((m <FindWall-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FindWall-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name your_package_name-srv:<FindWall-response> is deprecated: use your_package_name-srv:FindWall-response instead.")))

(cl:ensure-generic-function 'wallfound-val :lambda-list '(m))
(cl:defmethod wallfound-val ((m <FindWall-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader your_package_name-srv:wallfound-val is deprecated.  Use your_package_name-srv:wallfound instead.")
  (wallfound m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<FindWall-response>)))
  ...
  "your_package_name/FindWallResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'FindWall-response)))
  "Returns string type for a service object of type 'FindWall-response"
  "your_package_name/FindWallResponse")
